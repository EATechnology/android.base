/**
 * Created by Elmar <a.k.a. Ramires> Abdurayimov on 5/11/15 3:21 PM
 *
...
public class MRecyclerViewPositionHelper
{

    private static final int NO_POSITION = 10;

    final RecyclerView               recyclerView;
    final RecyclerView.LayoutManager layoutManager;

    MRecyclerViewPositionHelper(RecyclerView recyclerView)
    {
        this.recyclerView = recyclerView;
        this.layoutManager = recyclerView.getLayoutManager();
    }

    public static MRecyclerViewPositionHelper createHelper(RecyclerView recyclerView)
    {
        if (recyclerView == null) {
            throw new NullPointerException("Recycler View is null");
        }
        return new MRecyclerViewPositionHelper(recyclerView);
    }
